...
- Dados dos jogos Olímpicos e Paralímpicos
...
- Extração via Web Scraping:
  ...
  Indicadores de desenvolvimento (IDH) - Extraído através de dados da Wikipédia.
  
  Dados econômicos (PIB) - Extraído através de dados do portal Worldmeters.
  
  Dados de medalhas - Países e suas respectivas medalhas nas Olimpíadas e Paralimpiadas através de dados da Wikipédia.
